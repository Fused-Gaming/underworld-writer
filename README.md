...
![Underworld Writer release notes](release-artifacts/release-card-hero.svg)
...
Release artwork is derived from the changelog rather than maintained as an unrelated manual graphic.
