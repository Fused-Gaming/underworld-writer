...
# Generated bytes are runtime data, not source — never committed to Git,
# mirroring modal/README.md: "Large audio files belong in Modal/object
# storage, not Git." This is a local staging directory only.
